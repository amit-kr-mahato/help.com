                      ...
                      <div class="container d-flex justify-content-center align-items-center ">
                        ...
                        <div class="row border rounded-5 p-3 bg-white shadow box-area">
                          ...
                          <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box" style="background: #103cbe;">
                            ...
                            <small class="text-white text-wrap text-center" style="width: 17rem;font-family: 'Courier New', Courier, monospace;">Join experienced on this platform.</small>
                          </div>
                          <!-------------------- ------ Right Box ---------------------------->
                          ...
                          <div class="col-md-6 right-box">
                            <div class="row align-items-center">
                              ...
                              <div class="input-group mb-1">
                                <input type="password" class="form-control form-control-lg bg-light fs-6" placeholder="Password" id="myInput2">
                              </div>
                    ...
                    <form action="">
                      ...
                      <div class="container d-flex justify-content-center align-items-center">
                        ...
                        <div class="row border rounded-5 p-3 bg-white shadow box-area">
                          ...
                          <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box" style="background: #103cbe;">
                            <div class="featured-image mb-3">
                              <img src="https://cdn-icons-png.flaticon.com/512/5721/5721113.png" alt="" class="img-fluid" style="width: 250px;">
                            </div>
                          ...
                          <div class="col-md-6 right-box">
                            <div class="row align-items-center">
                              ...
                              <div class="input-group mb-3">
                                <input type="text" class="form-control form-control-lg bg-light fs-6" placeholder="User Name">
                              </div>
                              <div class="input-group mb-3">
                                <input type="text" class="form-control form-control-lg bg-light fs-6" placeholder="Email address">
                              </div>
                              <div class="input-group mb-1">
                                <input type="password" class="form-control form-control-lg bg-light fs-6" placeholder="Password" id="myInput">
